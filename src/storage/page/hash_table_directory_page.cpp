...
namespace bustub {
void HashTableDirectoryPage::Init() { global_depth_ = 0; }
...
uint32_t HashTableDirectoryPage::GetLocalHighBit(uint32_t bucket_idx) { return 1U << local_depths_[bucket_idx]; }
